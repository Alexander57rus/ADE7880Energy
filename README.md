...
// с версии 1.2.0 -можно выбрать произвольный pin для управления SS
ADE7880_SPI eic(pin);  // необходимо указывать pin даже если используется по умолчанию  (10- uno, nano и т.д.)
eic.begin();         // инициализация
=======
